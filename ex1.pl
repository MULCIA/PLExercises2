...
/*
    Predicado que realiza la exploracion en profundidad por postorden y manteniendo el nivel en cada momento.
...
explora_hijos([HI,R,HD],[R|Rs],[N|Ps],N) :-
    ...
    append(HDs,HIs,Rs), % Adjunta nodo a la lista
    append(PDs,PIs,Ps). % Adjunta nivel a la lista
